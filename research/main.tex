...
\qquad Based on the foundation provided by the course, a Linux-like operating system was designed, implementing virtual memory (paging and segmentation), file system, interrupt handlers, system call handlers, exception handlers, multi-terminal, scheduler, etc.
